  ...
  useEffect(() => {
    ...
    if (taskToEdit) {
      ...
      setTaskData({
        ...
        completed: normalized.toLowerCase(),
        id: taskToEdit._id,
      });
    } else {
    ...
    async (e) => {
      ...
      try {
        ...
        const cleanData = {
          ...
          completed: taskData.completed.toLowerCase(),
        };
    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-black/20 z-50 flex items-center justify-center p-4">
      <div className="bg-white border border-purple-100 rounded-xl max-w-md w-full shadow-lg relative p-6 animate-fadeIn">
        <div className="flex justify-between items-center mb-6">
          ...
          <button
            onClick={onClose}
            className="text-gray-500 rounded-lg p-2 hover:text-gray-700 transition-colors"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="flex items-center border border-gray-300 rounded-lg px-3 py-2.5 focus-within:ring-2 focus-within:border-purple-500 transition-all duration-200">
              <input
                type="text"
                name="title"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-purple-500 transition-all duration-200 text-gray-800 placeholder-gray-400"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 focus:ring-2 focus:ring-purple-500 transition-all duration-200 text-gray-800"
                required
              >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-fuchsia-500 to-purple-600 text-white font-medium py-2.5 px-4 flex items-center justify-center gap-2 rounded-lg disabled:opacity-50 hover:shadow-md transition-all duration-200"
          >
            {loading ? (
              'Saving...'
            ) : taskData.id ? (

...
export const personalFields = [
    { username: "username", type: "text", placeholder: "Full Name", icon: User },
    { username: "email", type: "email", placeholder: "Email", icon: Mail },
]

export const securityFields = [
    { username: "current", placeholder: "Current Password" },
    { username: "new", placeholder: "New Password" },
    { username: "confirm", placeholder: "Confirm Password" },
];
...
export const FIELDS = [
    { username: "username", type: "text", placeholder: "Full Name", icon: User },
    { username: "email", type: "email", placeholder: "Email", icon: Mail },
    { username: "password", type: "password", placeholder: "Password", icon: Lock },
]
...
export const STAT_CARD = "p-3 md:p-4 rounded-xl bg-white shadow-sm border border-purple-100 hover:shadow-md transition-all duration-300 min-w-0";
export const ICON_WRAPPER = "p-1.5 md:p-2 rounded-lg";
export const VALUE_CLASS = "text-lg md:text-2xl font-bold truncate mb-1";
